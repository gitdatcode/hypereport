...
(function() {
    var currentIndex = 0;
    var currentReport = 1;
    var baseUrl = 'http://hypereport.ann';
    ...
    function changeColor() {
        ...
        document.querySelector('div.vs-container').style.backgroundImage = 'url('+ baseUrl +'/assets/january/images/1.jpg)';
        // document.querySelector('div.vs-container').style.display= 'none';
        ...
        if( sectionsCount >= 3 && Modernizr.csstransforms3d ) {
            ...
            links.forEach( function( el, i ) {
                el.addEventListener( eventtype, function( ev ) {
                    ev.preventDefault();
                    document.querySelector('div.vs-container').style.backgroundImage = 'url('+ baseUrl +'/assets/january/images/'+el.dataset.id+'.jpg)';
