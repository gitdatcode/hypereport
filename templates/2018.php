...
<head>
    ...
    <link rel="stylesheet" href="<?php url('css/hype.css'); ?>">
</head>
...
<script src="<?php url('js/jquery.min.js'); ?>"></script>
<script>window.jQuery || document.write('<script src="<?php url('js/vendor/jquery-3.3.1.min.js'); ?>"><\/script>')</script>
<script src="<?php url('js/bootstrap.min.js'); ?>"></script>
<script src="<?php url('js/hype.js'); ?>"></script>
