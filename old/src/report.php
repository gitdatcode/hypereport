...
$reports = [
    ...
    [
        ...
        'firstName' => 'DATCODE',
        'lastInitial' => '',
        'text' => "This year we did the most and then did some more. We reached over 300 members, and saw several of y'all launch your own projects. We also became an official non profit organization, setting us up for amazing things. We couldn't have done this without y'all and we're looking forward to a bigger, louder, 2019.",
